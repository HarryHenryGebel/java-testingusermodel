...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<?> handleResourceFoundException(
    ResourceFoundException rfe
  ) {
    ErrorDetail errorDetail = new ErrorDetail();
    errorDetail.setTimestamp(new Date());
  ...
  protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(
    ...
    errorDetail.setDeveloperMessage(
      "HTTP Method Not Valid for Endpoint (check for valid URI and proper HTTP Method)"
    );
    errorDetail.setErrors(helperFunctions.getConstraintViolation(ex));
  ...
  protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
    ...
    errorDetail.setDetail(
      "Path: " +
      request.getDescription(false) +
      " | Supported Content / Media Types are: " +
      ex.getSupportedMediaTypes()
    );
    errorDetail.setDeveloperMessage(
      "Content / Media Type Not Valid for Endpoint (check for valid URI and proper content / media type)"
    );
    errorDetail.setErrors(helperFunctions.getConstraintViolation(ex));
  ...
  protected ResponseEntity<Object> handleMissingServletRequestParameter(
    ...
    errorDetail.setTitle(
      "Parameter Missing for " + "Path: " + request.getDescription(false)
    );
    errorDetail.setDetail(
      "Parameter Missing: " +
      ex.getParameterName() +
  ...
  protected ResponseEntity<Object> handleServletRequestBindingException(
    ...
    errorDetail.setStatus(status.value());
    errorDetail.setTitle(
      "Path: " + request.getDescription(false) + " Request Binding Exception"
    );
    errorDetail.setDetail(ex.getMessage());
    errorDetail.setDeveloperMessage(ex.getClass().getName());
    errorDetail.setErrors(helperFunctions.getConstraintViolation(ex));
  ...
  protected ResponseEntity<Object> handleConversionNotSupported(
    ...
    errorDetail.setStatus(status.value());
    errorDetail.setTitle(
      "Path: " + request.getDescription(false) + " Conversion Not Support"
    );
    errorDetail.setDetail(ex.getMessage());
    errorDetail.setDeveloperMessage(
      ex.getClass().getName() + " " + ex.getMostSpecificCause()
    );
    errorDetail.setErrors(helperFunctions.getConstraintViolation(ex));
  ...
  protected ResponseEntity<Object> handleTypeMismatch(
    ...
    errorDetail.setStatus(status.value());
    errorDetail.setTitle(
      "Path: " + request.getDescription(false) + " Type Mismatch"
    );
    errorDetail.setDetail(ex.getMessage());
    errorDetail.setDeveloperMessage(
      ex.getClass().getName() + " " + ex.getMostSpecificCause()
  ...
  protected ResponseEntity<Object> handleHttpMessageNotReadable(
    ...
    errorDetail.setStatus(status.value());
    errorDetail.setTitle(
      "Path: " + request.getDescription(false) + " Message Not Readable"
    );
    errorDetail.setDetail(ex.getMessage());
    errorDetail.setDeveloperMessage(
      ex.getClass().getName() + " " + ex.getMostSpecificCause()
  ...
  protected ResponseEntity<Object> handleHttpMessageNotWritable(
    ...
    errorDetail.setStatus(status.value());
    errorDetail.setTitle(
      "Path: " + request.getDescription(false) + " Message Not Writable"
    );
    errorDetail.setDetail(ex.getMessage());
    errorDetail.setDeveloperMessage(
      ex.getClass().getName() + " " + ex.getMostSpecificCause()
  ...
  protected ResponseEntity<Object> handleMethodArgumentNotValid(
    ...
    errorDetail.setDetail(
      request.getDescription(false) + " | parameter: " + ex.getParameter()
    );
  ...
  protected ResponseEntity<Object> handleMissingServletRequestPart(
    ...
    errorDetail.setStatus(status.value());
    errorDetail.setTitle(
      request.getDescription(false) + " Missing Servlet Request"
    );
    errorDetail.setDetail(
      "Request Part Name: " + ex.getRequestPartName() + " | " + ex.getMessage()
    );
    errorDetail.setDeveloperMessage(ex.getClass().getName());
    errorDetail.setErrors(helperFunctions.getConstraintViolation(ex));
  ...
  protected ResponseEntity<Object> handleBindException(
    ...
    errorDetail.setDetail(ex.getMessage());
    errorDetail.setDeveloperMessage(
      ex.getClass().getName() + " " + ex.getBindingResult()
    );
    errorDetail.setErrors(helperFunctions.getConstraintViolation(ex));
  ...
  protected ResponseEntity<Object> handleNoHandlerFoundException(
    ...
    errorDetail.setDeveloperMessage(
      "Rest Handler Not Found (check for valid URI)"
    );
    errorDetail.setErrors(helperFunctions.getConstraintViolation(ex));
